...
def print_outcomes(sim_output, strategy_name):
    ...
    print(strategy_name)
    print("  Estimate of mean reward (dollars) and {:.{prec}%} confidence interval:".format(1 - P.ALPHA, prec=0),
...
def print_comparative_outcomes(sim_output_no_drug, sim_output_with_drug):
    ...
    print("Average increase in reward (dollars) and {:.{prec}%} confidence interval:".format(1 - P.ALPHA, prec=0),
          estimate_CI)
